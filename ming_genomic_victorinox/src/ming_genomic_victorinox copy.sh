...
main() {
    ...
    #docker load -i /xmzhuo_genomic.tar
    ...
    #docker load -i /data/in/xmzhuo_genomic.tar
    echo "loaded docker image"
    docker image ls
    docker container ls -a   

    docker run -v /data/:/gatk/data -it xmzhuo/genomic:4.0.9 bash /gatk/data/in/${cmd_sh_name[0]}  
